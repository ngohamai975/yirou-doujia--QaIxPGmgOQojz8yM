...
[原文链接-PHP 8.2 vs PHP 8.3 对比：新功能、性能提升和迁移技巧](https://github.com)
...
* [PHPCompatibility](https://github.com):[快柠檬](https://kuaininmeng.com) — PHP\_CodeSniffer 的版本兼容性检查规则
* [Rector](https://github.com) — 自动化代码升级工具
